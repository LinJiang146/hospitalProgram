...
import com.wei.client.HospitalFeignClient;
import com.wei.client.PatientFeignClient;
...
import com.wei.order.mapper.OrderMapper;
import com.wei.order.service.OrderService;
import com.wei.order.service.WeixinService;
import com.wei.vo.hosp.ScheduleOrderVo;
import com.wei.vo.msm.MsmVo;
import com.wei.vo.order.*;
...
public class OrderServiceImpl extends
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        RLock saveOrderLock = redissonClient.getLock("saveOrder:" + patientId.toString());
        saveOrderLock.lock();


        try{
            //通过redission分布式信号量，使判断可预约数量和预约操作变成一个原子操作，防止超量预约
            RSemaphore scheduleSemaphore = redissonClient.getSemaphore("scheduleId:" + scheduleId);
            boolean b = scheduleSemaphore.tryAcquire();
            if (!b) return -1L;
    ...
    public void patientTips() {
        ...
        for(OrderInfo orderInfo:orderInfoList) {
            ...
            msmVo.setParam(param);
            rabbitService.sendMessage(RabbitMQConst.EXCHANGE_DIRECT_MSM, RabbitMQConst.ROUTING_MSM_ITEM, msmVo);
        }
    }
