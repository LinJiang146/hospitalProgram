...
import com.wei.user.utils.ConstantWxPropertiesUtils;
import com.wei.user.utils.HttpClientUtils;
...
public class WeixinApiController {
    ...
    public String callback(String code,String state) {
        ...
        try {
            ...
            map.put("token", token);
            //跳转到前端页面
            return "redirect:" + ConstantWxPropertiesUtils.HOSPITAL_BASE_URL + "/weixin/callback?token="+map.get("token")+ "&openid="+map.get("openid")+"&name="+URLEncoder.encode(map.get("name"),"utf-8");
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
